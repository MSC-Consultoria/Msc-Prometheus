...
class HostingerVPS:
    ...
    def deploy_prometheus(self, project_path=None):
        ...
        # O upload é feito pelo deploy_runner.py antes de chamar este método
        # Portanto, NÃO devemos limpar o diretório aqui
...
Environment="PYTHONPATH=/var/www/prometheus/app"
ExecStart=/var/www/prometheus/venv/bin/python /var/www/prometheus/app/backend/api.py
Restart=always
...
"""
    ...
    location / {{
        root /var/www/prometheus/app/frontend;
