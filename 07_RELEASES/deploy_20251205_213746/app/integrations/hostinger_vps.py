...
class HostingerVPS:
    ...
    def deploy_prometheus(self, project_path=None):
        ...
        for cmd in commands:
            ...
            result = self.execute_command(f"sudo {cmd}")
        ...
        # Nota: O upload real dos arquivos deve ser feito antes disso.
        # O script deploy_vps.ps1 deve ser atualizado para usar SCP ou SFTP para enviar os arquivos.
        # Vou adicionar um método helper para upload de diretório se necessário, mas o foco agora é a config.
